...
function drop(event) {
    ...
    if (dropZone.classList.contains('no_status_content') || dropZone.classList.contains('not_start_content') || dropZone.classList.contains('in_progress_content') || dropZone.classList.contains('completed_content')) {
